...
const Feedback = () => {
    ...
    const validForm = () => {
        ...
        if (feedbackMessage === "") {
            ...
            setErrorField((pre) => ({
                ...pre,
                feedbackMessageError: "please give your feedback",
            }));
        }
        return formIsValid;
    };
            ...
            <Wrapper>
                ...
                >
                    <FormTopText>
                        ...
                        {/* <TextDivRight> */}
                        <RightHeading>
                            TELL US HOW YOU FEEL <br /> HOW YOU REALLY REALLY
                            FEEL?
                        </RightHeading>
                        {/* </TextDivRight> */}
                    </FormTopText>
                    <FormTop>
                        <FormLeft>
                            ...
                            {errorField.nameError.length > 0 && (
                                <ErrorSpan>{errorField.nameError}</ErrorSpan>
                            )}
                            <Input
                                type="text"
                                name="cname"
                            ...
                            />
                            {errorField.companyNameError.length > 0 && (
                                <ErrorSpan>
                                    {errorField.companyNameError}
                                </ErrorSpan>
                            )}
                            <Input
                                type="email"
                            ...
                            {errorField.emailError.length > 0 && (
                                <ErrorSpan>{errorField.emailError}</ErrorSpan>
                            )}
                            <Input
                                type="number"
                                name="contact"
                            ...
                            />
                            {errorField.phoneError.length > 0 && (
                                <ErrorSpan>{errorField.phoneError}</ErrorSpan>
                            )}
                        </FormLeft>
                        <FormRight>
                            <TextArea
                ...
                did we just become best friends?"
                            ></TextArea>
                            {errorField.feedbackMessageError.length > 0 && (
                                <ErrorSpan>
                                    {errorField.feedbackMessageError}
                                </ErrorSpan>
                            )}
                        </FormRight>
                    </FormTop>
