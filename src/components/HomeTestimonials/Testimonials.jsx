...
const Testimonials = () => {
    ...
    useEffect(() => {
        const getValues = async () => {
            ...
            const testimonyData = await axios.get(
                `${url}/testimonials?key=${key}`
            );
                ...
                <Slider {...settings} className="slider">
                    {testimonies.map((testimony, idx) => (
                        <div
                            key={testimony.id}
                            className={
                                idx === index ? "slides activeSlides" : "slides"
                            }
                        >
                            <Testimaonialscard
                                testimony={testimony}
